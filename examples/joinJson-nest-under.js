...
var data = JSON.parse(fs.readFileSync('examples/data/left-data-nested-three.json', 'utf-8'))
/*
[
  {
    "id": "1",
...
var newData = JSON.parse(fs.readFileSync('examples/data/new-data-two.json', 'utf-8'))
/*
[
  {
    "state_name": "Colorado",
