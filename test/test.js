...
//
var joinedResult = '{"data":[{"id":"1","name":"UT","avg_temp":72},{"id":"2","name":"WY","avg_temp":null},{"id":"3","name":"CO","avg_temp":34},{"id":"4","name":"NM","avg_temp":45}],"report":{"diff":{"a":["CO","NM","UT","WY"],"b":["CO","NM","UT"],"a_and_b":["CO","NM","UT"],"a_not_in_b":["WY"],"b_not_in_a":[]},"prose":{"summary":"3 rows matched in A and B. 1 row in A not in B. All 3 rows in B in A.","full":"Matches in A and B: CO, NM, UT. A not in B: WY."}}}'
var joinedResultNested = '{"data":[{"id":"1","name":"Utah","values":{"weather":{"avg_temp":72}}},{"id":"2","name":"Wyoming","values":{"weather":{"avg_temp":null}}},{"id":"3","name":"Colorado","values":{"weather":{"avg_temp":34}}},{"id":"4","name":"New Mexico","values":{"weather":{"avg_temp":45}}}],"report":{"diff":{"a":["Colorado","New Mexico","Utah","Wyoming"],"b":["Colorado","New Mexico","Utah"],"a_and_b":["Colorado","New Mexico","Utah"],"a_not_in_b":["Wyoming"],"b_not_in_a":[]},"prose":{"summary":"3 rows matched in A and B. 1 row in A not in B. All 3 rows in B in A.","full":"Matches in A and B: Colorado, New Mexico, Utah. A not in B: Wyoming."}}}'
...
var noMatchDataResult = '{"data":[{"id":"1","name":"UT","avg_temp":null},{"id":"2","name":"WY","avg_temp":null},{"id":"3","name":"CO","avg_temp":null},{"id":"4","name":"NM","avg_temp":null}],"report":{"diff":{"a":["CO","NM","UT","WY"],"b":["OH","TX","VT"],"a_and_b":[],"a_not_in_b":["CO","NM","UT","WY"],"b_not_in_a":["OH","TX","VT"]},"prose":{"summary":"No matches. Try choosing different columns to match on.","full":"No matches. A not in B: CO, NM, UT, WY. B not in A: OH, TX, VT."}}}'
