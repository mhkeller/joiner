...
var leftData = io.readDataSync(leftDataPath, 'utf-8')
var newData = io.readDataSync(newDataPath, 'utf-8')

var geoData = io.readDataSync(geoDataPath, 'utf-8')
var newGeoData = io.readDataSync(newGeoDataPath, 'utf-8')
...
describe('cli', function () {
  describe('left()', function () {
    ...
    var cmd = './bin/index.js -a ' + leftDataPath + ' -k ' + config.leftDataKey + ' -b ' + newDataPath + ' -l ' + config.rightDataKey
  ...
  describe('geoJson()', function () {
    it('should match expected geojson on id', function (done) {
      ...
      var cmd = './bin/index.js -g -a ' + geoDataPath + ' -b ' + newGeoDataPath + ' -l ' + config.rightDataKey
    ...
    it('should match expected geojson on property', function (done) {
      ...
      var cmd = './bin/index.js -g -a ' + geoDataPath + ' -k ' + config.leftDataKey + ' -b ' + newGeoDataPath + ' -l ' + config.rightDataKey + ' -p ' + config.path
